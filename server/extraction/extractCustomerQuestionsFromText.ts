...
11. For asked_by_name, use the speaker name if available, otherwise "Customer".
12. For question_turn_index, estimate the position in the conversation (1, 2, 3, etc).
