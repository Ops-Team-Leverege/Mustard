 ...
 * For GENERAL_HELP intent with drafting and advisory tasks.
 */
export function buildGeneralAssistancePrompt(params: {
  ...
  const { meetingContext, threadContext, isDrafting } = params;
  ...
  const draftingInstructions = isDrafting
    ? `\n\n=== DRAFTING MODE ===
You are drafting content. Focus on:
- Clear, professional language
- Appropriate tone for business communication
- Accurate information based on available context
- Actionable content`
    : '';
